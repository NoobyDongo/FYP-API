...
public class ProductCRUD extends HttpServlet {
    ...
    protected void doGet(
        ...
        if (id != null && !id.isEmpty()) {
            ProductBean p = db.queryById(full, id); // Log the exception details
    ...
    protected void doPut(
        ...
        ArrayList<ProductBean> p = db.queryByColumns(full, s);
    ...
    protected void doPost(
        ...
        for (var d : data) {
            String id;
            if (d.id == null)
                beans.add(db.create(d));

            else
                beans.add(db.update(d));
 ...
 * }
 * 
 * protected String fromUrl(HttpServletRequest request, HttpServletResponse
 * response, String key)
 * throws ServletException, IOException{
 * 
 ...
 * getServletContext().getRequestDispatcher("/error?error=Empty+Input+Value:+" +
 * key);
